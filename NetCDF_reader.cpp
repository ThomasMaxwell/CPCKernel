...
int netcdf_test( const char* input_file )
{
   ...
   NcFile dataFile( input_file, NcFile::ReadOnly );
   ...
   cerr << "num_dims: " << dataFile.num_dims() << endl;
   cerr << "num_vars: " << dataFile.num_vars() << endl;
   cerr << "rec_dim: " << dataFile.rec_dim()   << endl;
   cerr << "num_atts: " << dataFile.num_atts() << endl;
